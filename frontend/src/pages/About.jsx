...
function About() {
  return (
    <div>
      ...
      <div className='flex pt-8 my-10 flex-col md:flex-row gap-16'>
        <img className='w-full md:max-w-[450px]' src={about} alt="" />
        <div className='text-gray-600 flex  flex-col gap-6 md:w-2/4 justify-center'>
      ...
      <div className='flex flex-col md:flex-row text-sm mb-10'>
          <div  className='flex flex-col gap-5 border border-gray-300 px-10 md:px-16 py-8 md:py-20'>
